...
ui <- dashboardPage(
   dashboardHeader(title = t, titleWidth = 200, 
                   ...
                   tags$li(class="dropdown",tags$a(href="https://github.com/Aggarch/", 
                                                   ...
                                                   target="_blank")),
                   tags$li(class="dropdown",tags$a(href="https://www.teletrader.com/stanley-black-decker-shnc/stocks/balancesheet/tts-117457503", 
                                                   icon("accusoft","fa-2x"), "",
                                                   style= "padding-left:27px,width:550px;height:40px",
                                                   target="_blank")),
   ...
   dashboardSidebar(width = 200,
                    sidebarMenu(
                       ...
                       div(
                          tags$a(href="https://cran.r-project.org/web/packages/tidyquant/index.html",
                                 style = "padding-left:50px,width:2px;height:2px"),
                          # tags$a(href="https://fred.stlouisfed.org/" ,"©"),
                          
                          br(),
                          
                          tags$img(src='sbd.logo.png', height=50, width=200, 
